...
----
$ git clone git@github.com:kynuxyz/crpb
...
== More Information
You can learn more about this booster and the Node.js runtime in the link:http://launcher.fabric8.io/docs/nodejs-runtime.html[Node.js Runtime Guide].
